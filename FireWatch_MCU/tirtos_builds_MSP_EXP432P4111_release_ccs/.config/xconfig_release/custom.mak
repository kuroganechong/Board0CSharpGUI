...
linker.cmd: package/cfg/release_pem4f.xdl
	$(SED) 's"^\"\(package/cfg/release_pem4fcfg.cmd\)\"$""\"E:/HuuDuoc/WirelessBoard/tirtos_builds_MSP_EXP432P4111_release_ccs/.config/xconfig_release/\1\""' package/cfg/release_pem4f.xdl > $@
