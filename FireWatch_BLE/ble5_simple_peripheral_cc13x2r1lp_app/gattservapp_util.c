 ...
 * EXTERNAL VARIABLES
 */
extern uint16_t Character4handle;
extern uint16_t connectionHandleSend;
extern bool starthandleflag;
extern uint8 cccValue_char4;
/*********************************************************************
 * EXTERNAL FUNCTIONS
 */
                                          ...
                                          uint8 taskId, pfnGATTReadAttrCB_t pfnReadAttrCB )
{
  ...
  Character4handle = pAttr->handle;
  connectionHandleSend = connHandle;
